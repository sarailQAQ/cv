...
export default [
...

  {
    title: '初试成绩',
    content: [
      h(`报考院校：华东师范大学`, `报考专业：大数据技术与工程（专硕）`),
...

  {
    ...
    content: [
      h(`ICPC 系列竞赛`),
      p('*<small>ICPC 国际大学生程序设计竞赛（原 ACM-ICPC 竞赛），是一项旨在展示大学生创新能力、团队精神和在压力下编写程序、分析和解决问题能力的年度竞赛。</small>*'),
      p('主要奖项：'),
  ...
  },
  {
    title: '自我评价',
    content: [
      p(`本人积极向上，品行端正，工作态度积极，乐于学习和挑战新事物、新知识。热爱科技，善于利用开源社区（Github等）学习技术、了解行业动向。代码能力优秀，大学期间开发了多个项目，参与多个科技竞赛，有丰富的源码阅读经验，阅读过 Gin、BigCache、TiDB（部分）等项目源码。`)
    ]
  }
]